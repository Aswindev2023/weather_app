...
class ApiHelper {
  ...
  static const weeklyWeatherUrl = 'https://api.open-meteo.com/v1/forecast?';
  ...
  static String _constructWeeklyForecastUrl() =>
      '${weeklyWeatherUrl}latitude=$lat&longitude=$lon&daily=temperature_2m_max,temperature_2m_min,weather_code&current=temperature_2m,weather_code&timezone=auto';
